...
class Rank():
    ...
    def __ne__(self, rank2):
        return not self.__eq__(rank2)

    def __lt__(self, rank2):
        return not self.__ge__(rank2)

    def __le__(self, rank2):
        if self.rankLetter > rank2.rankLetter or (self.rankLetter == rank2.rankLetter and
                                                  self.rankNumber <= rank2.rankNumber):
            return True
        else:
            return False
